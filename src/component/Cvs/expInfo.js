...
export default function WorkExp({nextStep,prevStep,updateForm,values}){
  return(
  ...
  <Card.Body>
    ...
    nextStep()
      ...
      <legend className="card-title">Experience Info</legend>
      <Form.Group>
        <Form.Label>Job Role</Form.Label>
      <Form.Control type="text" placeholder="Job Role" value={values.jobtitle} onChange={(e)=>updateForm({jobtitle:e.target.value})} />
    </Form.Group>
       <Form.Group>
    ...
    <Form.Group>
        ...
        <Form.Control type="date" placeholder="Start at"value={values.startscompanyAt} onChange={(e)=>updateForm({startcompanyAt:e.target.value})} />
      </Form.Group>
      <Form.Group>
